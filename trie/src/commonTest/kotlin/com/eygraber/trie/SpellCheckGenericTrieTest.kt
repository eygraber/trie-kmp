...
abstract class SpellCheckGenericTrieTest {
...
class CompactSpellCheckGenericTrieTest : SpellCheckGenericTrieTest() {
  override fun createDictionary(
    words: List<String>,
  ): GenericTrie<Char, Boolean> = compactGenericTrieOfString(*words.map { it to true }.toTypedArray())
}

class StandardSpellCheckGenericTrieTest : SpellCheckGenericTrieTest() {
  override fun createDictionary(
    words: List<String>,
